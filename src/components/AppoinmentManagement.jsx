...
import { Calendar, Plus, ArrowLeft, Edit, Trash2, User, DollarSign, FileText, Clock } from "lucide-react";
        ...
        <div className="p-4 sm:p-6 border-b border-gray-200">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <div className="relative flex-1">
              <Calendar className="w-4 h-4 sm:w-5 sm:h-5 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
              <input
                type="date"
                value={searchDate}
                onChange={(e) => {
            ...
            {searchDate && (
              <button
                ...
                className="px-4 py-2 text-gray-600 hover:text-gray-800 text-sm sm:text-base whitespace-nowrap"
              >
                Clear
              </button>
            )}
                ...
                appointments.map((appointment) => (
                  <tr key={appointment._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`font-medium ${getBalanceColor(appointment.totalAmount, appointment.paidAmount)}`}
                      >
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-3 bg-gray-50 rounded-lg">
                      <div className="text-center">
                        ...
                        <div className="text-sm font-medium text-gray-900">₹{appointment.totalAmount}</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xs text-gray-500 mb-1">Paid Amount</div>
                        <div className="text-sm font-medium text-green-600">₹{appointment.paidAmount}</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xs text-gray-500 mb-1">Balance</div>
                        <div className={`text-sm font-medium ${getBalanceColor(appointment.totalAmount, appointment.paidAmount)}`}>
                          ₹{appointment.totalAmount - appointment.paidAmount}
                        </div>
                      </div>
                    </div>
